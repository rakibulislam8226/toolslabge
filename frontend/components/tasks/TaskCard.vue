<template>
    <div class="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-300 p-4">
        <!-- Task Header -->
        <div class="flex items-start justify-between mb-3">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="relative">
                        <select :value="task.status?.id || ''" @change="onStatusChange"
                            class="text-xs bg-gray-50 border border-gray-200 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div class="relative ml-2">
                ...
                <div v-if="showDropdown" v-click-outside="closeDropdown"
                    class="absolute right-0 top-6 mt-1 w-32 bg-white rounded-lg shadow-lg border z-10">
        ...
        <div class="space-y-2">
            <!-- Dates -->
            <div v-if="task.due_date || task.start_date" class="flex items-center text-xs text-gray-500">
                ...
                <span>
                    <span v-if="task.start_date">Start: {{ formatDate(task.start_date) }}</span>
                    <span v-if="task.start_date && task.due_date"> | </span>
                    <span v-if="task.due_date" :class="{ 'text-red-500': isOverdue }">
