<template>
  <BaseModal :is-open="isOpen" title="Edit Member Role" size="md" @close="handleClose">
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <!-- Role Selection -->
      <BaseSelect v-model="form.role" label="New Role" :options="roleOptions" required :error="fieldErrors.role" />
