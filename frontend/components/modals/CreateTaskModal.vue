<template>
    <BaseModal :is-open="isOpen" title="Create New Task" size="xxl" @close="closeModal">
        <!-- Form -->
            ...
            <div>
                ...
                <div
                    ...
                    <label v-for="member in projectMembers" :key="member.id"
                        class="flex items-center space-x-2 hover:bg-white dark:hover:bg-gray-700 p-1 rounded cursor-pointer">
